/*Define a class library with book title author and number of copies as data members. 
implement methods to add new books,issue books and retuen books.Ensure that the number of copies is approximately updated for each operation*/ 
#include <iostream>
#include <string>
using namespace std;
